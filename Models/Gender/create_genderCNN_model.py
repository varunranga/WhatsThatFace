...
dataset_file = 'gender_dataset_train.txt'
build_hdf5_image_dataset(dataset_file, image_shape=(100, 100), mode='file', output_path='gender_dataset_train.h5', categorical_labels=True, normalize=True)

print("Done.\n")

print("Creating validating hdf5 file")

dataset_file = 'gender_dataset_validation.txt'
build_hdf5_image_dataset(dataset_file, image_shape=(100, 100), mode='file', output_path='gender_dataset_validation.h5', categorical_labels=True, normalize=True)

print("Done.\n")

print("Getting train X and Y")

h5f = h5py.File('gender_dataset_train.h5', 'r')
X = h5f['X']
Y = h5f['Y']
...
h5f = h5py.File('gender_dataset_validation.h5', 'r')
validation_x = h5f['X']
validation_y = h5f['Y']
...
model.save('gender_modelFit.model')
