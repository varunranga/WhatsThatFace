...
dataset_file = 'glasses_dataset_train.txt'
build_hdf5_image_dataset(dataset_file, image_shape=(100, 40), mode='file', output_path='glasses_dataset_train.h5', categorical_labels=True, normalize=True)

print("Done.\n")

print("Creating validating hdf5 file")

dataset_file = 'glasses_dataset_validation.txt'
build_hdf5_image_dataset(dataset_file, image_shape=(100, 40), mode='file', output_path='glasses_dataset_validation.h5', categorical_labels=True, normalize=True)

print("Done.\n")

print("Getting train X and Y")

h5f = h5py.File('glasses_dataset_train.h5', 'r')
X = h5f['X']
Y = h5f['Y']
...
X = X.reshape([-1, 100, 40, 3])
validation_x = validation_x.reshape([-1, 100, 40, 3])
...
model.save('glasses_modelFit.model')
